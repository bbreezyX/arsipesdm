  ...
  return (
    <div className="form-grid">
      <Field label="Jenis transport darat">
        <Combobox
          aria-label="Jenis transport darat"
          value={value.mode}
          maxLength={1000}
      ...
      <Field label="Jenis BBM">
        <Combobox aria-label="Jenis BBM" value={value.fuelType} maxLength={1000}
          options={["Pertalite", "Pertamax", "Pertamax Turbo", "Solar", "Dexlite", "Pertamina Dex"].map(value => ({value}))}
      ...
      <NumberField label="Jumlah liter BBM" value={value.fuelLiters} step="any"
        onChange={fuelLiters => updateFuel({fuelLiters})} hint="Jumlah liter sesuai bukti pembelian, boleh desimal." />
      <NumberField
        className="span-2"
